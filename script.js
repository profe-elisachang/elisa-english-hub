...
async function scanLessons() {
    ...
    const potentialFiles = [
        ...
        { filename: '2026-02Bricked-Up Windows in England.html', date: '2026-02-18', title: '🏛️ What\'s Up with All Those Bricked-Up Windows in England?' },        { filename: '2026-02 The Beauty of Broken Things.html', date: '2026-02-20', title: '🏺 The Beauty of Broken Things' },        // 👆 在此上方添加新文章，記得加逗號！  
